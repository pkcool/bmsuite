package com.enginemobi.core.constants;

import java.util.HashMap;
import java.util.Locale;

/**
 * constants used for db schema
 */
public class SchemaConstant {

    public final static String BMSUITEDB_SCHEMA = "BMSUITEDB";

    /**
     * The name of the table generator
     */
    public final static String TABLE_GENERATOR_NAME = "TABLE_GEN";

    /**
     * The database table name of the table used by the generator
     */
    public final static String TABLE_GENERATOR_TABLE_NAME = "BM_SEQUENCER";

    /**
     * The primary key column name for the table used by the generator
     */
    public final static String TABLE_GENERATOR_PKCOLUMN_NAME = "SEQ_NAME";

    /**
     * The value column name for the table used by the generator
     */
    public final static String TABLE_GENERATOR_VALUE_COLUMN_NAME = "SEQ_COUNT";
