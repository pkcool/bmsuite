...
import com.enginemobi.core.offer.domain.OfferCode;
import com.enginemobi.core.offer.domain.OfferInfo;
import com.enginemobi.core.offer.domain.OrderAdjustment;
...
/**
 * Defines an order in BmSuite.    There are several key items to be aware of with the Order.
 *
 ...
 */
public interface Order extends BmSuiteEntity<Long, Order>, Auditable {
